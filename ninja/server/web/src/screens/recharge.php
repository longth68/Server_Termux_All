<div class="d-inline d-sm-flex justify-content-center">
   <div class="col-md-8 mb-5 mb-sm-4">
      <div class="d-flex align-items-center justify-content-between">
         <a href="/ranking"></a><small class="fw-semibold">Tích lũy: <?php echo $user['tongnap'];?>%</small></div>
      <div class="recharge-progress">
         <div class="progress-container">
            <div class="progress-main">
               <div class="progress-bar" style="width: <?php echo $user['tongnap'];?>%;"></div>
...
<?php
    if($tab == "card" || $tab == "") include_once('recharge/card.php');
?>
