...
public class ConstNpc {
    ...
    // ===== CASINO (Lý Tiểu Nuông): Xóc Đĩa / Bầu Cua / Chọn Ai Đây X =====
    public static final int XOC_DIA_MENU = 2150;
    public static final int BAU_CUA_MENU = 2152;
    public static final int CAD_X_MENU = 2153;
    public static final int CAD_GOLD_SELECT = 2154;
    public static final int CAD_GEM_SELECT = 2155;
    public static final int CAD_RUBY_SELECT = 2156;
    ...
    // ===== Khảm Ngọc / Phòng Thí Nghiệm / Rương Sưu Tầm (port hashirama) - giữ nguyên id menu nguồn =====
