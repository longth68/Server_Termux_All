                ...
                if (pl.getSession().version >= 237) {
                    try {
                        ...
                        if (plSell != null) {
                            ...
                            // Bot ảo không có trong DB -> tra theo id int da cat bot
                            nro.virtualplayer.VirtualPlayer botSeller = nro.virtualplayer.VirtualPlayerManager.gI().getBotByIntId(itk.player_sell);
                            msg.writer().writeUTF(botSeller != null ? botSeller.name : "");
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
