...
<!-- Navigation remains the same, just change active state -->
<div class="card mb-4">
    <div class="card-body p-0">
        <nav class="nav nav-pills nav-fill ranking-nav">
            <a class="nav-item nav-link" href="Top.php">
                <i class="fas fa-coins me-2"></i>Xếp Hạng Nạp
            </a>
            <a class="nav-item nav-link active" href="TopPower.php">
        ...
        <div class="row justify-content-center align-items-center text-center py-4">
            ...
            <div class="col-4 top-player">
                ...
                <div class="position-relative" style="margin-top: 40px;">
                    ...
                    <div class="amount"><?php echo number_format($top3[1]['tong_power']) ?> Sức Mạnh</div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-4 top-player">
                ...
                <div class="position-relative">
                    ...
                    <div class="amount" style="font-size: 1.3em;"><?php echo number_format($top3[0]['tong_power']) ?> Sức Mạnh</div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-4 top-player">
                ...
                <div class="position-relative" style="margin-top: 60px;">
                    ...
                    <div class="amount"><?php echo number_format($top3[2]['tong_power']) ?> Sức Mạnh</div>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
<div class="card">
    <div class="card-header bg-primary text-white">
        <h4 class="mb-0 text-center">Bảng Xếp Hạng Sức Mạnh</h4>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>
                                ...
                                <td>{$row['char_name']}</td>
                                <td>" . number_format($row['power']) . "</td>
                                <td>" . number_format($row['power_pet']) . "</td>
                                <td>" . number_format($row['tong_power']) . "</td>
                              </tr>";
                        $rank++;
                    }
                    ?>
