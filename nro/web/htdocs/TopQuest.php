        ...
        <div class="row justify-content-center align-items-center text-center py-4">
            ...
            <div class="col-4 top-player">
                ...
                <div class="position-relative" style="margin-top: 40px;">
                    ...
                    <div class="amount"><?php echo htmlspecialchars($top3[1]['task_name']) ?></div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-4 top-player">
                ...
                <div class="position-relative">
                    ...
                    <div class="amount" style="font-size: 1.3em;"><?php echo htmlspecialchars($top3[0]['task_name']) ?></div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-4 top-player">
                ...
                <div class="position-relative" style="margin-top: 60px;">
                    ...
                    <div class="amount"><?php echo htmlspecialchars($top3[2]['task_name']) ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
<div class="card">
    <div class="card-header bg-primary text-white">
        <h4 class="mb-0 text-center">Bảng Xếp Hạng Nhiệm Vụ</h4>
    </div>
    <div class="card-body">
